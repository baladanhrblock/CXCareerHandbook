...
const uxDesign: DisciplineData = {
  id: "ux-design",
  title: "UX Design",
  description: "Understanding customer needs and translating them into intuitive, accessible, and effective product experiences.",
  skillChips: [
    "Design system",
    "UI controls & icons",
    "Visual design",
  ...
  uniqueRows: [
    {
      id: "ux-ideation-concept",
      label: "Ideation & Concept Development",
      type: "unique",
      tag: "UX craft",
      cells: {
        associate: { text: "Generates multiple ideas for clearly defined problems and can explain the strengths and tradeoffs of each approach.", provenance: "draft" },
        mid: { text: "Explores a range of possible solutions, evaluates tradeoffs, and helps the team align on a clear direction for a feature.", provenance: "draft" },
        senior: { text: "Helps teams understand the right problem to solve, especially when requirements are unclear or competing.", provenance: "draft" },
        lead: { text: "Guides concept development across a squad and helps the team decide where design effort will have the most impact.", provenance: "draft" },
        principal: { text: "Identifies new experience opportunities and helps shape the direction that multiple teams design toward.", provenance: "draft" },
      },
    },
    {
      ...
      tag: "UX craft",
      cells: {
        associate: { text: "Applies established structure and navigation patterns within an existing product experience.", provenance: "draft" },
        mid: { text: "Designs the structure of a feature, including navigation, content hierarchy, user flows, and alternate paths.", provenance: "draft" },
        senior: { text: "Creates clear structures for complex product areas and resolves conflicts between competing flows or use cases.", provenance: "draft" },
        lead: { text: "Helps teams create connected experiences across products and resolves structural issues that span multiple areas.", provenance: "draft" },
        principal: { text: "Shapes the information architecture principles that guide how the organization structures product experiences.", provenance: "draft" },
      },
    },
    {
    ...
    {
      id: "ux-applied-research",
      label: "Applied Research",
      type: "unique",
      tag: "UX craft",
      cells: {
        associate: { text: "Uses existing research to inform design decisions and participates in research activities led by others.", provenance: "draft" },
        mid: { text: "Plans and runs evaluative research on their own work, synthesizes findings, and applies what they learn to improve the design.", provenance: "draft" },
        senior: { text: "Identifies gaps in customer understanding, finds the right evidence, and knows when more research is needed before moving forward.", provenance: "draft" },
        lead: { text: "Helps teams make evidence-based decisions and partners with research when deeper customer understanding is needed.", provenance: "draft" },
        principal: { text: "Builds practices that help teams stay connected to customer needs and make better decisions over time.", provenance: "draft" },
      },
    },
    {
      id: "ux-craft-execution",
      label: "Craft & Execution",
      type: "unique",
      tag: "UX craft",
      cells: {
        associate: { text: "Delivers work that meets established quality expectations and checks that implementation matches design intent.", provenance: "draft" },
        mid: { text: "Owns a feature from concept through delivery, including specifications, engineering handoff, design QA, and iteration.", provenance: "draft" },
        senior: { text: "Tackles unfamiliar problems, balances constraints, and consistently delivers high-quality solutions with clear rationale.", provenance: "draft" },
        lead: { text: "Raises the quality bar for a product area and helps the team make intentional tradeoffs during design and delivery.", provenance: "draft" },
        principal: { text: "Defines what high-quality experience looks like at the organizational level and helps teams consistently work toward that standard.", provenance: "draft" },
      },
    },
  ],
};
...
export function isDisciplineId(value: string | null | undefined): value is DisciplineId {
  return !!value && (DISCIPLINE_ORDER as readonly string[]).includes(value);
}
